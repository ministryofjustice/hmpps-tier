    ...
    companion object {
        ...
        fun liferAndReleaseDateCases(): List<Arguments> {
            ...
            return listOf(
                ...
                Arguments.of(true, today.minusYears(1).minusDays(1), C),
                Arguments.of(true, today.minusYears(2), C),
                Arguments.of(true, today.minusYears(4).plusDays(1), C),
                Arguments.of(true, today.minusYears(4), C),
                Arguments.of(true, today.minusYears(4).minusDays(1), D),
                Arguments.of(true, today.minusYears(5).plusDays(1), D),
                Arguments.of(true, today.minusYears(5), D),
                Arguments.of(true, today.minusYears(5).minusDays(1), G),
                Arguments.of(true, today.minusYears(6), G),
