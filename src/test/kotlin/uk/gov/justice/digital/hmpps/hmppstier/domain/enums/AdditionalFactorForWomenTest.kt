...
class AdditionalFactorForWomenTest {
  ...
  inner class SectionsTest {
    ...
    fun `PARENTING_RESPONSIBILITIES should be in section 13`() {
      assertThat(AdditionalFactorForWomen.PARENTING_RESPONSIBILITIES.section).isEqualTo("13")
    }
  ...
  inner class ValuesTest {
    ...
    fun `It should match PARENTING_RESPONSIBILITIES`() {
      assertThat(AdditionalFactorForWomen.from("13.3 - F")).isEqualTo(AdditionalFactorForWomen.PARENTING_RESPONSIBILITIES)
    }
