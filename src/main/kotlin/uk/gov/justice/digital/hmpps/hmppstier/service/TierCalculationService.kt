    ...
    private fun calculateTier(crn: String, recalculationSource: RecalculationSource): TierCalculationEntity {
        ...
        return TierCalculationEntity(
            ...
            data = TierCalculationResultEntity(
                tier = result.tier.takeIf { featureFlags.v3CalculationEnabled },
                provisional = result.provisional.takeIf { featureFlags.v3CalculationEnabled },
                change = changeLevel,
                protect = protectLevel,
                calculationVersion = if (featureFlags.v3CalculationEnabled) "3" else "2",
