...
dependencies {
    ...
    testImplementation("org.junit.platform:junit-platform-console:6.0.1") // Manually set to 6.0.1 for cucumber 7.26.0
    testImplementation("org.junit.platform:junit-platform-launcher:6.0.1") // Manually set to 6.0.1 for cucumber 7.26.0
}
